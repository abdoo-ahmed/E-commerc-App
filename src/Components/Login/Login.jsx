...
const ValidateScima = yup.object({
  ...
  password:yup.string().required("password is required").matches(/^[A-Za-z][A-Za-z0-9]{5,8}$/ , `password pattern is inavalid `),
...
export default function Login() {
  ...
  <div className="container m-auto p-5">
    ...
    <form onSubmit={myFormik.handleSubmit} >
      ...
      <p className='me-auto forgetLogin '>
        forget your password ?
      </p>

      <button onClick={ ()=>{onClick()}} type='submit' className='rounded-3 btn before-btn ms-auto '> 
        ...
        colors={['black', 'black', 'black', 'black', 'black']}/> : "login Now" }
