        ...
        <div className="container inner_Pages">
          <div className="row  d-flex justify-content-center slider_center">
            ...
            <div className="col-md-4 p-3">
              <img
                style={{ height: "250px" }}
                className="w-100"
                src={require("../../images/XCM_Manual_1396328_4379575_Egypt_EG_BAU_GW_DC_SL_Bags_Wallets_379x304_1X._SY304_CB650636675_.jpg")}
                alt="Bags"
              />
              ...
              <img
                style={{ height: "250px" }}
                className="w-100"
                src={require("../../images/XCM_Manual_1533480_5305769_379x304_1X._SY304_CB616236518_.jpg")}
                alt="Gitar"
              />
            </div>
          </div>
          ...
          <div className="products row my-5 g-4">
            {allProducts.map((product, index) => (
              <div key={index} className="col-md-3 overflow-hidden">
                <Link className="product" to={`/ProductDetails/${product.id}`}>
                  <div>
                    {/* {   imageCover    } */}
                    <img
                      className="mt-3 rounded-2 w-100"
                      src={product.imageCover}
                      alt=""
                    />

                    <h3 className="ms-2 h6 text-main">
                      {" "}
                      {product.category.name}{" "}
                    </h3>
                    <h2 className="ms-2 h5">
                      {" "}
                ...
                <button
                  ...
                  className="AddBtn btn w-100 bg-main text-white m-auto d-block "
                >
                  + Add
                </button>
              </div>
