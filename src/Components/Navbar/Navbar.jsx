    ...
    <>
      <nav className="navbar navbar-expand-lg bg-body-tertiary">
        <div className="container">
          <Link className="navbar-brand logo_nav d-flex" to="/">
            <ul>
              <li className=" fa-solid icon_nav fa-cart-shopping nav-icon">
                {" "}
              </li>{" "}
            </ul>{" "}
            fresh cart{" "}
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            {mytoken ? (
              <ul className="navbar-nav m-auto mb-2 mb-lg-0">
                ...
                <li className="nav-item">
                  <Link className="nav-link" to="/Catrgories">
                    {" "}
                    catrgories
                  </Link>
                </li>
                  ...
                  <ul className="list-unstyled d-flex">
                    <li className="nav-item me-3 position-relative">
                      <li
                        ...
                        className="me-2 fa-solid icon_nav icon_Cart fa-cart-shopping nav-icon"
                      >
                        {" "}
                      </li>
