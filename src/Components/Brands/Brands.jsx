...
export default function Brands() {
  ...
  return <>
    ...
    <div className="text-center AllBrands inner_Pages">
        <h1 className='text-AllBrands mb-5'>
          All Brands
        </h1>
    </div>
    ...
    <div className="container">
      ...
      <div className="row g-4">
        ...
        {data.data.data.map(( brand , index )=><>
          ...
          <div data-bs-toggle="modal" data-bs-target={"#"+brand._id} key={index} className="col-md-3">
        ...
        {data.data.data.map(( brand , ind)=> <>
          ...
          <div key={ind} class="modal fade move_Brand" id={brand._id} tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <h1 className='text-main model_brand'> {brand.name} </h1>
                      <p> {brand.name} </p>
                    </div>
