...
export default function SimpleSlider() {
  ...
  return (
    <Slider {...settings}>
      <div>
        <img style={{height: "400px"}} className="w-100" src={im1} alt="Chair Blue"  />
      </div>
      
      <div>
        <img style={{height: "400px"}} className="w-100" src={im2} alt=" bag bink " />
      </div>

      <div>
        <img style={{height: "400px"}} className="w-100" src={im3} alt="stickers" />
      </div>
