...
export default function Cart() {
  ...
  if (AllProucts.length) {
    return (
      <>
        {AllProucts ? (
          <div className="container cart p-5">
            <div className="row">
                ...
                <Link to="/check-out">
                  <div className="d-flex">
                    <button
                      ...
                      className="w-50  m-auto btn btn-primary"
                    >
                      {" "}
                      Check Out{" "}
                    </button>
            ...
            {AllProucts.map((product, index) => (
              <div key={index} className="row py-3 align-items-center ">
                  ...
                  <article>
                    ...
                    <div className="text-danger">
                      ...
                      >
                        ...
                        <span className="mt-5">Remove</span>
                      </button>
                    </div>
                  </article>
                </div>
            ...
            <div className="d-flex">
              <button
                ...
                className="btn m-auto btn-outline-danger"
              >
                {" "}
                Clear Your Cart{" "}
              </button>
